...
module.exports = {
    async AddRandomKtp(req, res, next) {
        ...
        try {
            ...
            //banyak data tergantung looping disini
    ...
    async addRandomCaleg(req,res,next){
        try {
            ...
            // console.log("jumlah parpols ",parpolresults.length)
    ...
    async updateKTP(req,res,next){
        try {
            // const updatedata = await Ktp.updateMany({kabkot:'Kota '},{
            //     $set:{kabkot:'Kota Serang'}
            // })     ;
            const updatedata = await Ktp.find({kabkot:'Kota Serang'})     ;
            res.json(updatedata)      
        } catch (error) {
            console.log("error ", error);
